        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {collectionsList.map((c) => (
            <Link
              ...
              className="group flex flex-col bg-[#faf7f0] border border-[#eadfc9] hover:border-[#a8843c] transition-all overflow-hidden"
            >
              <div className="h-80 bg-[#f5efe2] relative overflow-hidden">
                <ImageSlot
                  src={c.coverImage}
              ...
              <div className="p-8 flex flex-col gap-3">
                ...
                <h3 className="font-serif text-3xl font-medium text-[#211c15] group-hover:text-[#a8843c] transition-colors">
                  {c.name}
                </h3>
                <p className="text-xs font-light leading-relaxed text-[#5f5748]">
                  {c.description}
                </p>
                <div className="pt-2 text-xs uppercase tracking-[0.2em] text-[#211c15] group-hover:text-[#a8843c] inline-flex items-center gap-1 font-medium">
