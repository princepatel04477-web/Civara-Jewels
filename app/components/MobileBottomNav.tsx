...
export const MobileBottomNav = () => {
  ...
  return (
    ...
    >
      <div className="bg-[#181412]/94 backdrop-blur-2xl border border-[#C9A961]/40 rounded-full px-3 py-2 shadow-2xl flex items-center justify-center gap-1 max-w-md mx-auto">
