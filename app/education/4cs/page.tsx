    ...
    <div className="w-full bg-[#FAF7F0] text-[#211C15]">
      ...
      <section className="py-16 px-6 lg:px-20 max-w-4xl mx-auto space-y-12 text-xs sm:text-sm font-light text-[#6E6459] leading-relaxed">
        ...
        <div className="text-center pt-6 space-y-4">
          <a
            href="https://wa.me/918866077237?text=Hello%20Civara%20Atelier%2C%20I%20would%20like%20to%20consult%20about%20diamond%20selection."
            target="_blank"
          ...
          >
            <MessageCircle className="w-4 h-4" /> Consult Our Master Gemmologist
          </a>
        </div>
      </section>
    </div>
